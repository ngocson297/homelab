export type OrderStatus = "PENDING_CONFIRMATION" | "CONFIRMED" | "COLLECTOR_ASSIGNED" | "COLLECTOR_ON_THE_WAY" | "COLLECTED" | "IN_TRANSIT" | "CANCELLED";
