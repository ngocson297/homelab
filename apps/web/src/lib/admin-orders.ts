...
export type AdminOrderListItem = { orderCode: string; status: OrderStatus; statusLabel: string; contactName: string; maskedPhone: string; appointment: null | { scheduledDate: string; timeSlot: string; province: string; district: string; ward: string }; itemCount: number; specimenCount: number; rejectedSpecimenCount: number; requiresRecollection: boolean; totalAmount: string; version: number; createdAt: string; updatedAt: string };
